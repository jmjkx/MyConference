...
if __name__ == '__main__':
    ...
    parser.add_argument('--dim', type=int,  default=30, metavar='dim', help='MFA dim')
    ...
    plot(imgPos, imgGt, IMAGE.shape, d + name + modelname)
    imgPos = np.array(list(traindata.pos) + list(validdata.pos))
    imgGt = np.array(list(traindata.gt) + list(validdata.gt))
    plot(imgPos, imgGt, IMAGE.shape, d + 'traindata.pdf')
